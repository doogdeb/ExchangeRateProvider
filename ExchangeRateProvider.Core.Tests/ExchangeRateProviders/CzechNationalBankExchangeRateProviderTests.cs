...
{
    public class CzechNationalBankExchangeRateProviderTests : IDisposable
    {
        private readonly Mock<ICzechNationalBankExchangeRateApi> _czechNationalBankExchangeRateApi;
        private readonly Mock<AbstractLogger<Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider>> _logger;
        private readonly IOptions<ExchangeRateProviderOptions >_options;
        private readonly Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider _provider;
        ...
        public CzechNationalBankExchangeRateProviderTests()
        {
            ...
            _logger = new Mock<AbstractLogger<Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider>>(MockBehavior.Strict);
            _options = Microsoft.Extensions.Options.Options.Create(new ExchangeRateProviderOptions());

            _provider = new Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider(_czechNationalBankExchangeRateApi.Object,
        ...
        public void Ctor_NullApi_ThrowsArgumentNullException()
        {
            var exception = Assert.Throws<ArgumentNullException>(() =>
                new Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider(default!,
                    _options, _logger.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(() =>
                new Core.ExchangeRateProviders.CzechNationalBankExchangeRateProvider(_czechNationalBankExchangeRateApi.Object,
